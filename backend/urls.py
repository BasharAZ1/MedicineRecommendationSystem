...
from views import (
    ...
    search, get_medicine_info, fda_search,write_interactions,drugs_data_fetch
)
...
def configure_routes(app):
    ...
    app.add_url_rule('/drugs_data_fetch', 'drugs_data_fetch', drugs_data_fetch, methods=["GET"])
